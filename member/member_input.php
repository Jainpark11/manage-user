...
if (!isset($_POST['chk']) or $_POST['chk'] != 1) {
    // die("<script>
    // alert('약관을 동의하신 후 접근하시기 바랍니다.')
    // self.location.href='./stipulation.php'</script>");
    ...
    <form name="input_form" method="post" enctype="multipart/form-data" autocomplete="off" action="pg/member_process.php">
        ...
        <div class="d-flex gap-2 align-items-end">
            <div>
                ...
                <input type="text" name="id" id="f_id" class="form-control" id="f_id" placeholder="아이디를 입력하세요">
            </div>
        ...
        <div class="mt-3 d-flex gap-2 align-items-end">
            <div>
                ...
                <input type="text" name="name" id="f_name" class="form-control" id="f_name" placeholder="이름을 입력하세요">
            </div>
        </div>
        ...
        <div class="d-flex gap-2 align-items-end">
            <div class="flex-grow-1">
                ...
                <input type="text" name="email" id="f_email" class="form-control" id="f_email" placeholder="이메일을 입력하세요">
            </div>
        ...
        <div class="d-flex mt-3 gap-2 justify-content-between">
            <div class="flex-grow-1">
                ...
                <input type="text" class="form-control" name="addr1" id="f_addr1" placeholder="주소 입력하세요">
            </div>
            <div class="flex-grow-1">
        ...
        <div class="mt-3 d-flex gap-5">
            ...
            <img src="https://static.vecteezy.com/system/resources/previews/008/302/512/non_2x/eps10-grey-user-solid-icon-or-logo-in-simple-flat-trendy-modern-style-isolated-on-white-background-free-vector.jpg" id="f_preview" class="w-25" alt="profile image">
        </div>
